...
<body class="w100">
                ...
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <div class="profile_ifo_area">
                            <form action="${pageContext.request.contextPath }/front/user_updateUser" method="post">
    ...
    <script src="${pageContext.request.contextPath }/res/js/jquery.cityselect.min.js"></script>
