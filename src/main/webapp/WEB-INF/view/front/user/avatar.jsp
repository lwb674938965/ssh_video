                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            <c:if test="${empty user.headUrl}">
                                 <img  src="${pageContext.request.contextPath }/res/img/avatar_lg.png">
                            </c:if>
                            
                            <c:if test="${not empty user.headUrl}">
                                  <img width="200px" height="280px" src="${user.headUrl}">
                            </c:if>
                        ...
                        <div class="profile_ifo_area">
                            <form id="upload_form" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath }/front/user_updateHeadImg" >
                                <p>请选择图像文件</p>
                                <div><input type="hidden" name="thisId" value="${user.id}">
