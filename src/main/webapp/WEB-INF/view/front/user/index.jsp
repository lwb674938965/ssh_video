...
<body>
   <jsp:include page="/WEB-INF/view/front/user/uheader.jsp"></jsp:include>
    ...
    <footer>
        <div class="container">
            <ul>
                <li><img src="${pageContext.request.contextPath }/res/img/footer_logo.png" alt="" id="foot_logo"></li>
                <li>版权所有：智游3G教育&#x3000;&#x3000;&#x3000;&copy;&nbsp;www.zhiyou100.com</li>
                <li><img src="${pageContext.request.contextPath }/res/img/微信公众号.png" alt="" id="wxgzh"></li>
            </ul>
        </div>
    </footer>
</body>
