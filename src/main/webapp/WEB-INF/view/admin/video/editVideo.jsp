...
<html>
	...
	<jsp:include page="/WEB-INF/view/admin/admin.jsp">
		...
		<div class="container">
			...
			<form class="form-horizontal" action="${pageContext.request.contextPath }/admin/video_editVideo" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control" id="inputPassword3" name="speakerId" >
							...
							<option value="${sl.id }" ${video.speaker.id == sl.id ? "selected":"" }>${sl.speakerName }</option>
							</c:forEach>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control" id="inputPassword3" name="courseId">
							...
							<option value="${cl.id }" ${video.course.id == cl.id ? "selected":"" }>${cl.courseName }</option>
							</c:forEach>
						</select>
					</div>
				</div>
