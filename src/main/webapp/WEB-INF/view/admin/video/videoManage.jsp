					        ...
					        confirm:{
					        	 ...
					        	 action:function () {
									 $.ajax({
										 ...
										 data:{"thisId":id},
										 type:"post",
										 url:"${pageContext.request.contextPath }/ajax/ajax_deleteVideo",
		...
		<div class="container theme-showcase">
			...
			<div>
				...
				<div class="navbar-form navbar-left">
					...
					<a href="${pageContext.request.contextPath }/admin/video_addVideoView" class="btn btn-primary" >添加视频</a>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<form class="navbar-form navbar-right" action="${pageContext.request.contextPath }/admin/video_videoList" method="post">
            ...
            <form action="${pageContext.request.contextPath }/admin/video_deleteMany">
			...
			<table class="table table-hover">
			 <thead>
			     ...
			     <tr>
			     	...
			     	<td><a class="glyphicon glyphicon-edit" role="button" href="${pageContext.request.contextPath }/admin/video_editVideoView?thisId=${video.id}&page=${page1.page}"></a></td>
			...
			</table><input type="hidden" value="${page1.page}" name="page">
			</form>
			</div>
			<div>
			   <div style="float:right;margin-right: 50px;margin-top: -10px; ">  
			 
                <bobo:page url="${pageContext.request.contextPath }/admin/video_videoList"></bobo:page>
                </div>
