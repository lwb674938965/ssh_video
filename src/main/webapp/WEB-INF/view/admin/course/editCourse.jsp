...
<html>
	...
	<jsp:include page="/WEB-INF/view/admin/admin.jsp">
		...
		<div class="container">
			...
			<form class="form-horizontal" action="${pageContext.request.contextPath }/admin/course_editCourse" method="post">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control" name="subjectId">
							...
							<option value="${sj.id }" ${course.subject.id==sj.id?"selected":"" }>${sj.subjectName }</option>
							</c:forEach>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
			     ...
			     <input type="hidden" name="insertTime" value="${course.insertTime }">
