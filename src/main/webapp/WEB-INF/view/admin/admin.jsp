				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li ${param.fromJsp=="video"?"class='active'":"" }>
							<a href="${pageContext.request.contextPath }/admin/video_videoList">视频管理</a>
						</li>
						<li ${param.fromJsp=="speaker"?"class='active'":"" }>
							<a href="${pageContext.request.contextPath }/admin/speaker_speakerList">主讲人管理</a>
						</li>
						<li ${param.fromJsp=="course"?"class='active'":"" }>
							<a href="${pageContext.request.contextPath }/admin/course_courseList">课程管理</a>
						</li>
						<li ${param.fromJsp=="analysis"?"class='active'":"" }>
							<a href="${pageContext.request.contextPath }/admin/video_videoAnalysis">统计分析</a>
						</li>
					...
					<div class="nav navbar-nav navbar-right">
						<div class="navbar-brand">
							<a href="#" >${ad.login_name }</a><a href="${pageContext.request.contextPath }/admin/admin_exitController" class="glyphicon glyphicon-share" ></a>				
					    </div>
					</div>
				</div>
			</div>
